...
contract RaffleTest is Test {
    ...
    {
        // Act
        vm.recordLogs(); // cheat code that records all emitted events into a log array. All logs are recorded in bytes32 in foundry
    ...
    function testFulfillRandomWordsCanOnlyBeCalledAfterPerformUpkeep(uint randomRequestId)
        public
        raffleEnteredAndTimePassed
    {
       ...
       raffleEnteredAndTimePassed
    {
        ...
        for (
            ...
            hoax(player, 1 ether); // deal 1 eth to the player cheatcode
            raffle.enterRaffle{value: entranceFee}();
        }
